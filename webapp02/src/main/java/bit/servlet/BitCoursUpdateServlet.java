...
@WebServlet("/bit_cours/update.do")
public class BitCoursUpdateServlet extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
    ...
    bitCours.setCourseNo(Integer.parseInt(request.getParameter("cono")));
